...
def Get_Stats(YEAR):
    ...
    #TEXT = "dict = {'entry_id':{},'Date': {}, 'TotalValue': {}, 'PieValue': {}, 'Investment': {}, 'PieInvestment': {}, 'Realised': {}, 'Dividend': {}, 'InvValue': {}   }".format(DENTRYID,DDATE,DTOTAL,DPIE,DINV,DPIEINV,DREAL,DDIV,DVAL)
    #Date,TotalValue,PieValue,Investment,PieInvestment,Realised,Dividend,InvValue
    TEXT = "{},{},{},{},{},{},{},{},{},{}".format(DENTRYID,DDATE,DTOTAL,DPIE,DINV,DPIEINV,DREAL,DDIV,DVAL,DPER)
    TEXT = "{},{},{},{},{},{},{}".format(DDATE,DTOTAL,DINV,DREAL,DDIV,DVAL,DPER)
    return TEXT
